...
<body>
    <header class="header" style="display:flex; justify-content:space-between; align-items:center;">
        ...
        <div style="display:flex; gap:10px; width:250px; justify-content:flex-end; align-items:center;">
            <?php if(isAdmin()): ?>
                <a href="admin.php" class="nav-link" style="background-color:#9BD576; font-size:1.4rem; padding:8px 15px; margin:0;">Admin</a>
            <?php endif; ?>
            <?php if(isLoggedIn()): ?>
                <a href="login.php?logout=1" class="nav-link" style="background-color:#ff6b6b; color:#fff; font-size:1.4rem; padding:8px 15px; margin:0;">Logout</a>
            <?php else: ?>
                <a href="login.php" class="nav-link" style="font-size:1.4rem; padding:8px 15px; margin:0;">Login</a>
            <?php endif; ?>
        </div>
    </header>
